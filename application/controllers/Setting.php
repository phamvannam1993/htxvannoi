    ...
    public function getForm($data) {
        ...
        return [
            ...
            [
                ...
                'value' => isset($data['phone_number_1']) ? $data['phone_number_1'] : '',
                'required' => true,
                'type' => 'text',
            ],
            [
                ...
                'value' => isset($data['phone_number_2']) ? $data['phone_number_2'] : '',
                'required' => true,
                'type' => 'text',
            ],
            [
            ...
            [
                'title' => 'Link facebook',
                'field' => 'facebook_link',
                'value' => isset($data['facebook_link']) ? $data['facebook_link'] : '',
                'required' => true,
                'type' => 'text',
            ],
            [
                'title' => 'Google link',
                'field' => 'google_link',
                'value' => isset($data['google_link']) ? $data['google_link'] : '',
                'required' => true,
                'type' => 'text',
            ],
        ];
